module Ghost where
    ...
    data Ghost = Ghost { state :: TVar GhostState, frame :: TVar GhostFrame, point :: TVar Base.Point, textures :: TVar GhostTextureMap, sprites :: SDL.Texture }
    ...
    newGhost sprites = do
        ...
        return (Ghost state frame point textures sprites)
    ...
    moveGhost ghost direction = do
        ...
        when (isValidPosition i j) (setPoint ghost p)
